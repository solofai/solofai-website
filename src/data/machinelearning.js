// src/data/machinelearning.js
export const mlEngineering = {
  title: "Machine Learning Engineer",
  icon: "🔒",
  role: "ML Engineer - Cyber Hardware Security & Assurance",
  company: "Chip Scan",
  website: "chipscan.us",
  location: "Remote",
  ...
  previous: [
    {
      role: "Machine Learning Engineer - Signal Demodulation Research",
      company: "Geon Technologies, LLC",
      website: "https://geontech.com/",
      location: "Columbia, MD",
      duration: "Oct 2021 - Apr 2022",
      description: "Investigated machine learning approaches to signal demodulation using Transformer, LSTM, and BiRNN architectures.",
      responsibilities: [
        "Developed and experimented with Transformer, LSTM, and BiRNN models for signal demodulation on synthetic sequential data",
    ...
    },
    {
      ...
      description: "Researched CV algorithms to extract mission-critical information and led programmatic coordination.",
      responsibilities: [
        "Researched object detection and image processing for text extraction from videos using YOLO and Faster R-CNN",
        "Explore Sobel and Canny filters for text overlay extraction in videos using OpenCV",
    ...
    },
    {
      ...
      website: "https://ecs.syracuse.edu/",
      ...
      responsibilities: [
        ...
        "Collaborated with Assured Information Security (AIS) to build a prototype Haskell-based compiler automating formal methods verification of a UAV mission"
      ],
      technologies: [
